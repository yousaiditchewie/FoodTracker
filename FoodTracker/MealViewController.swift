...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    /*
     * The original code for imagePickerController
     * from the tutorial no longer works
     * I found this code in this Stack Overflow answer:
     *
    ...
    */
    ...
    @IBAction func selectImageFromPhotoLibrary(_ sender: UITapGestureRecognizer) {
        ...
        // if the user taps the image view
        // while typing in the text field,
        ...
        // Make sure ViewController is notified
